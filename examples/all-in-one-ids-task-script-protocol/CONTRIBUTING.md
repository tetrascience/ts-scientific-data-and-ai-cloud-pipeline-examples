...
```sh
ts-sdk put ids {namespace} {slug} {version} ./ids
```

```sh
poetry run generate-requirements
ts-sdk put task-script {namespace} {slug} {version} ./task_script
```

```sh
ts-sdk put protocol {namespace} {slug} {version} ./protocol
```
...
```sh
poetry run generate-requirements
ts-sdk put task-script private-jfoldager jxf-demo-ssp v0.1.0 ./task_script
```

### Upload protocol

```sh
ts-sdk put protocol private-jfoldager jxf-demo-ssp v0.1.0 ./protocol
```
